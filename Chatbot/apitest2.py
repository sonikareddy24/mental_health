...
def take_command():
    ...
    with sr.Microphone() as source:
        ...
        r.dynamic_energy_threshold = True  # Enable dynamic adjustment
...
def get_gemini_response(prompt):
    try:
        ...
        return response.text if response.text else "I'm sorry, I couldn't process your request at the moment."
...
def chat():
    speak("Hello! How can I support your mental health today?")
    ...
    while True:
        ...
        if mode == "1":
            ...
            query = get_gemini_response(input("You: "))
        else:
